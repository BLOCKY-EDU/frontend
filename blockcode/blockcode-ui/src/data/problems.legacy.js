...
//   <block type="container_box" x="190" y="90">
...
//       // 3) 인라인 스타일을 실제로 썼는지(속성 이름만 확인)
//       requireInlineStyles: ["text-align", "font-family"],

//       // 4) 값까지 확인 (컨테이너 div에 스타일이 들어가므로 div 기준)
//       requireInlineStylesAt: [
//         { selector: "div", prop: "text-align", value: "center", mode: "includes" },
//         { selector: "div", prop: "font-family", value: "georgia", mode: "includes" } // "Georgia, 'Times New Roman', serif" 전부 OK
//       ],
...
//   },
//   {
//     id: 2, title: "여백에 대해 알아보자!", image: img2,
//     answerXml: `
//       <xml xmlns="https://developers.google.com/blockly/xml">
//     <block type="container_box" x="230" y="50">
//       <statement name="CONTENT">
//         <block type="text_title">
//           <field name="TITLE">여백에 대해 알아보자!</field>
//         </block>
//       </statement>
//       <statement name="STYLE">
...
//       `,
//     rules: {
//       // 1) 핵심 요소: 제목 h1이 있어야 함
//       requiredSelectors: ["h1"],

//       // 2) h1 텍스트 정확히 일치
//       requireTextAt: [
//         { selector: "h1", text: "여백에 대해 알아보자!", mode: "equals" }
//       ],

//       // 3) 인라인 스타일 사용 확인
//       //    parseStyleStatementsToStyleObj가 margin을 longhand로 풀어 쓰므로
//       //    'margin-top' 속성 존재 여부로 체크
//       requireInlineStyles: ["margin-top"],

//       // 4) 인라인 스타일 값 검증 (컨테이너 div에 4방향 모두 16px)
//       requireInlineStylesAt: [
